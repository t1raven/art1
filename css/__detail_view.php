...
<section id="marketRView">
    ...
    <div class="inner_view">
          <header class="header">
            ...
            <ul class="sns">
              <li><button type="button" onclick="shareFaceBook();"><img src="/images/market/btn_sns1_off.gif" alt="페이스북" onmouseover="$(this).imgConversion(true);" onmouseout="$(this).imgConversion(false);" ></button></li>
              <li><button type="button" onclick="sharePinterest();"><img src="/images/market/btn_sns2_off.gif" alt="핀터레스트" onmouseover="$(this).imgConversion(true);" onmouseout="$(this).imgConversion(false);"></button></li>
            ...
            <button class="close">
              <img src="/images/market/btn_close_off.gif" alt="닫기" onmouseover="$(this).imgConversion(true);" onmouseout="$(this).imgConversion(false);">
            </button>
          </header>
              ...
              <div class="product_des">
                  ...
                  <div class="group_rgh">
                      <p class="price">
                          ...
                          <?php if (trim($Work->attr['rental_exchange_text']) !== '렌탈불가') : ?><span class="info_rantal">(렌탈 기간에 따라 렌탈료가 할인됩니다. <a href="rental/index.php?goods=<?php echo $Work->attr['goods_idx']?>" class="link">렌탈정책보기</a> )</span><?php endif; ?>
              ...
              <div class="lst about">
                  <ul>
                      ...
                      <li>
                          ...
                          <div class="cont"><?php echo strtr($Artist->attr['artist_birthday'], '-', '.');?></div>
                      </li>
                      <li>
                          <div class="h">장르</div>
                  ...
                  <div class="inner">
						...
						<?php if (is_array($recommendList)): ?>
							<?php foreach($recommendList as $row): ?>
                              <li>
                                 <!--div class="img"><a href="/maketPlace/artwork_view.php?goods=<?php echo $row['goods_idx'];?>"><img src="<?php echo goodsListImgUploadPath, $row['goods_list_img'];?>" alt=""></a></div-->
                                 <div class="img"><a href="#" onclick="goods='<?php echo $row['goods_idx']; ?>'; marketViewMotion(); return false;"><img src="<?php echo goodsListImgUploadPath, $row['goods_list_img'];?>" alt=""></a></div>
                                  <div class="txt">
...
function marketViewOpen(){
	...
	function resize(){
		var winWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
            ...
            marketViewViewport.css("display","block");
