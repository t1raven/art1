					...
					?>
						<li>
							<div class="img">
								...
								<div class="delete"><button type="button" onclick="topDeleteGoods('<?php echo $row['goods_idx'];?>');"><img src="/images/header/btn_delete.gif" alt="" /></button></div>
							</div>
							<div class="cont">
