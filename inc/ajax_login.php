...
<section id="loginArea" class="content-mediaBox margin1">
   <div class="inner">
  ...
  <?php } ?>
      <div class="lft_group">
        ...
        <div class="left">
          <p><input type="text" name="uid" id="uid<?php echo $ajax_state;?>" value="<?php echo $cook_user_id;?>" class="n_txt" class="inp {label:'아이디',required:true}" placeholder="ID" required /></p>
          <p><input type="password" name="upwd" id="upwd<?php echo $ajax_state;?>" class="n_txt"  value="" class="inp {label:'비밀번호',required:true}" placeholder="Password" required/></p>
         </div>
         <p class="add">
          ...
          <div class="btn">
            <a href="javascript:loginCheck();" class="login" >로그인</a>
...
<div class="rgh_group">
      ...
      <div class="joinBox">
          <div class="inner">
              ...
              <div class="btn">
              	<a href="/member/join/?at=write">회원가입하기</a><!-- a href="/member/join.php">회원가입하기</a -->
              	<a href="/member/search/" class="search_accout">비밀번호찾기</a>
          	</div>
          </div>
      </div>
