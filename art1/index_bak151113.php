      ...
      function playVid(n,t) {
          ...
          if(!document.getElementById("movA"+idx)){
          	<?if($check_mobile === false){?>
          		$this.parent().append("<video id='movA"+idx+"' poster='/images/bg/bg_mov_noPlay"+idx+".jpg' controls=''><source src='/ArtistRec"+idx+".mp4' type='video/mp4'><source src='ArtistRec"+idx+".ogv' type='video/ogv'></video>");
          	<?}else{?>
          		$this.parent().append("<video id='movA"+idx+"' poster='/images/bg/bg_mov_noPlay"+idx+".jpg' controls=''><source src='/ArtistRec"+idx+"_m.mp4' type='video/mp4'><source src='ArtistRec"+idx+"_m.ogv' type='video/ogv'></video>");
          	<?}?>
          }
