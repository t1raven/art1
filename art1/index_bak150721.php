          ...
          <section id="art1_exhibition" class="content-mediaBox margin1">
			 ...
			 <article id="name8" class="photographer n8">
                 <div class="movie"  id="movIeA8">
                     ...
                     <button class="play" onclick="playVid(7,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                     <video id="movA8" poster="/images/bg/bg_mov_noPlay8.jpg" controls=""><source src="/ArtistRec8.mp4" type="video/mp4"><source src="ArtistRec8.ogv" type="video/ogv"></video>
                     <?}else{?>
			 ...
			 <article id="name7" class="photographer n7">
              ...
              <article id="name6" class="photographer n6">
                 <div class="movie"  id="movIeA6">
                     ...
                     <button class="play" onclick="playVid(5,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                     <video id="movA6" poster="/images/bg/bg_mov_noPlay6.jpg" controls=""><source src="/ArtistRec6.mp4" type="video/mp4"><source src="ArtistRec6.ogv" type="video/ogv"></video>
                     <?}else{?>
                 ...
                 <div class="movie"  id="movIeA5">
                     ...
                     <button class="play" onclick="playVid(4,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                     <video id="movA5" poster="/images/bg/bg_mov_noPlay5.jpg" controls=""><source src="/ArtistRec5.mp4" type="video/mp4"><source src="ArtistRec5.ogv" type="video/ogv"></video>
                     <?}else{?>
                 ...
                 <div class="t1">
                  ...
                  <div class="info">
                    <div class="photo"><img src="/upload/artist/1425026028CEGG67WS9Q.jpg" alt="LEE HYUN BAE (b.1979)" width="145"></div><!-- //photo -->
                    <div class="cont">
              ...
              <article id="name4" class="photographer n4">
                  ...
                  <? if($check_ie === false){ ?>
                      ...
                      <button class="play" onclick="playVid(3,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                      <video id="movA4" poster="/images/bg/bg_mov_noPlay4.jpg" controls=""><source src="/ArtistRec4.mp4" type="video/mp4"><source src="ArtistRec4.ogv" type="video/ogv"></video>
              ...
              <article id="name3" class="photographer n3">
                  <div class="movie" id="movIeA3">
                        ...
                        <button class="play" onclick="playVid(1,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                        <video id="movA3" poster="/images/bg/bg_mov_noPlay3.jpg" controls="">
                        <source src="/ArtistRec3.mp4" type="video/mp4">
                        <source src="ArtistRec3.ogv" type="video/ogv"></video>
                        <?}?>
                      <!-- <iframe src="https://www.youtube.com/embed/_n7FcY3ND0I" frameborder="0" allowfullscreen></iframe>
                      <iframe src="//www.youtube.com/embed/_n7FcY3ND0I?version=2&loop=1&autoplay=0&wmode=transparent&playlist=_n7FcY3ND0I" frameborder="0" allowscriptaccess="always" allowfullscreen="true" wmode="Opaque" ></iframe> -->
                  </div>
                  <!-- width="1280" height="750"  -->
              ...
              <article  id="name2" class="photographer n2">
                  <div class="movie"  id="movIeA2">
                      ...
                      <button class="backPlay"  onclick="playVid(1,this);"><img src="/images/bg/bg_mov2.jpg" alt=""></button>
                        <button class="play" onclick="playVid(1,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                  <!-- width="1280" height="750"  -->
                      <video id="movA2" poster="/images/bg/bg_mov_noPlay3.jpg" controls=""><source src="/ArtistRec2.mp4" type="video/mp4"><source src="ArtistRec2.ogv" type="video/ogv"></video>
                      <?}?>
                      <!-- <iframe src="https://www.youtube.com/embed/iOFXVQC1GOM" frameborder="0" allowfullscreen></iframe>
                      <iframe src="//www.youtube.com/embed/iOFXVQC1GOM?version=2&loop=1&autoplay=0&wmode=transparent&playlist=iOFXVQC1GOM" frameborder="0" allowscriptaccess="always" allowfullscreen="true" wmode="Opaque" ></iframe> -->
                  </div>
              ...
              <article id="name1" class="photographer n1">
                  <div class="movie"  id="movIeA1">
                      ...
                      <button class="play" onclick="playVid(0,this);"><img src="/images/btn/btn_play2.png" alt="동영상 플레이 하기"></button>
                      <video id="movA1" poster="/images/bg/bg_mov_noPlay1.jpg" controls=""><source src="/ArtistRec1.mp4" type="video/mp4"><source src="ArtistRec1.ogv" type="video/ogv"></video>
                      <?}else{?>
...
<?}?>
      ...
      function playVid(n,t) { 
          ...
          vid[n].play(); 
          vid[n].addEventListener("ended", function () {
