    ...
    <div class="container_inner">
      <? include "../inc/path.php"; ?> 
          ...
          <section id="art1_exhibition" class="content-mediaBox margin1">
			 ...
			 <article id="name11" class="photographer n11">
                 <div class="movie"  id="movIeA11">
                     <? if($check_ie === false){ ?>
                     <button class="backPlay"  onclick="playVid(10,this);"><img src="/images/bg/bg_mov11.jpg" alt=""></button>
                     <?}else{?>
                 ...
                 <h1> 삶을 건축하는 조각가 </h1>
                 <div class="t1">
					<p>음정수는 한 층 한 층 쌓아 올려 완성되는 건축물을 통해 하루하루의 삶이 모여 완성된 인간의 삶을 발견한다.</p>
					<p>실제 건축의 과정처럼 철저한 설계와 구상의 단계를 거쳐 이루어지는 음정수의 작업은 마치 한 사람의 인생사처럼 오랜 인고의 시간과 많은 노력을 통해 완성된다.</p>
					<p>속도는 조금 느리지만 꾸준히 진행되는 그의 작업은 경쟁사회 속에서 ‘빨리빨리’문화에 젖어있는 현대인들에게 타인의 삶 그리고 나 자신의 삶을 성찰할 수 있는 계기를 제공한다.</p>
					<p>단순히 작품의 완성에서 끝나는 것이 아니라 작업의 시작부터 마지막 결과물의 완성까지의 모든 과정 속에서 음정수의 철학과 인생관을 고스란히 느낄 수 있어 그의 작품과 감상자 사이의 간격은 더욱 가까워진다.</p>
					<p>한 발 한 발 천천히 자신만의 길을 걸어가는 음정수처럼 오늘만큼은 여유롭게 내가 걸어온 길을 돌아보면 어떨까.</p>
                 </div> 
                  
                  <div class="info">
                    <div class="photo"><img src="/images/art1/artist_photo11.jpg" alt="음정수" width="155"></div><!-- //photo -->
                    <div class="cont">
                        <h2><span>음정수</span> EUM JEONG SOO <a href="/marketPlace/artist.php?idx=98"><img src="/images/market/btn_more.jpg" alt="자세히 보기"></a></h2>
                        <dl class="n1">
                          <dt>개인전</dt>
                          <dd><span class="year">2015</span> Built 人, 갤러리 도스</dd>
                          <dd><span class="year"></span> </dd>
                          <dd><span class="year"></span> </dd>
                        </dl>
                        <dl class="n2">
                          <dt>단체전</dt>
                          <dd><span class="year">2015</span> NEW & EMERGING ARTISTS, LVS PROJECT</dd>
                          <dd><span class="year">2014</span> 2014 가송예술상 – 제4회 여름생색전, 공아트스페이스</dd>
                          <dd><span class="year">2013</span> KOREA TOMORROW 2013, 예술의 전당 한가람 미술관</dd>
                        </dl>
                    </div><!-- //cont -->
                  </div><!--//info -->
			 ...
			 <article id="name10" class="photographer n10">
                 <div class="movie"  id="movIeA10">
                     <? if($check_ie === false){ ?>
                     <button class="backPlay"  onclick="playVid(9,this);"><img src="/images/bg/bg_mov10.jpg" alt=""></button>
                     <?}else{?>
			 ...
			 <article id="name7" class="photographer n7">
                 ...
                 <div class="t1">
                  ...
                  <div class="info">
                    ...
                    <div class="cont">
                        <h2><span>슈가미트</span> SUGERMEAT <a href="/marketPlace/artist.php?idx=77"><img src="/images/market/btn_more.jpg" alt="자세히 보기"></a></h2>
                        <dl class="n1">
                          <dt>개인전</dt>
...
<? if($check_ie === true){ ?>
  $(function(){
      var jwp =null,jwp2 =null, jwp3 =null, jwp4 =null, jwp5 =null, jwp6 =null, jwp7 =null, jwp8 =null, jwp9 =null;
       jwp = jwplayer('movIeA1').setup({
        ...
        jwp2 = jwplayer('movIeA2').setup({
         ...
         jwp3 = jwplayer('movIeA3').setup({
          ...
          jwp11 = jwplayer('movIeA11').setup({
                           controls: false, // v6
                           controlbar: "none", //v5
                           width: "100%",
                           height: "100%",
                           image: "/images/bg/bg_mov_noPlay11.jpg",
                           autostart: false,
                           repeat:"always",
                           icons: false, // disable a big play button on the middle of screen
                           flashplayer: "/swf/jwplayer44.swf",
                           file: "/ArtistRec11.flv"
                       });                       
})
<?}?>
      ...
      var vid = [
        ...
        document.getElementById("movA9"),
        document.getElementById("movA10"),
        document.getElementById("movA11")
      ]
      var vid_name = [
      	"ArtistRec1",
      	"ArtistRec2",
