      ...
      <? include "../inc/path.php"; ?>  
		...
		<section id="photographerArea" class="content-mediaBox margin1">
			<section class="benfit_lst">
				<h1 class="title8 top_line">작가등록 혜텍</h1>
				<div class="txtBox">
					<p>
						온라인 마켓에서 뉴스, 영상아카이브, 커뮤니티까지 원스톱 미술포털을 지향하는 아트1은 대한민국 온라인 미술시장의 새로운 지평을 열고, 작가와 대중이 함께 만나는 장이 되기를 희망합니다. 
						또한 아트1 온라인 마켓에서는 작품거래에 있어 작가 중심의 수수료정책을 적용하여, 국내작가들의 보다 활발한 작품 활동을 장려하고 실질적인 지원책을 마련하고자 합니다. 많은 작가분들의 관심과 참여 바랍니다.
					</p>
				</div>
				<div class="inner">
					<ul class="clearfix">
				...
				<div class="inner">
					<ul>
						<li>
							...
							<div>
								<h2><span class="ipt">art1.com 작가등록 페이지에 작가등록 정보 작성</span><a href="#">작가등록하기 +</a></h2>
							</div>
						</li>
						<li>
							<h1><img src="/images/ico/ico_arti_proc02.gif" alt="단계2"/></h1>
							<div class="bg_lock">
								<h2><span class="ipt">웹하드(webhard.co.kr) 로그인</span><a href="#" target="_blank">자료업로드하기 +</a></h2>
								<p class="tip">아이디 &nbsp;art1com &nbsp;/ &nbsp;비밀번호 &nbsp;art1com</p>
								<dl class="circle_pc">
									<dt><span class="h100"></span><span>GUEST그룹<span class="tmp">폴더</span></span></dt>
									<dd><img src="/images/bg/bg_arrow.gif" alt="화살표"/></dd>
								...
								<dl class="note">
									...
									<dd><span>3</span> 작품이미지 첨부(5점 이상, 사이즈: 300dpi 이상 2mb 이하)
										<ul>
											<li>작품이미지 파일명으로 [제목, 재료, 제작년도, 작품판매가(시장거래가), 프레임유무] 기재</li>
			...
			<section class="contact_info">
				...
				<ul class="clearfix">
					<li><div><img src="/images/bg/ico_email02.gif" alt="email"><span>E-mail: </span>art1@art1.com / curator@art1.com</div></li>
					<li><div><img src="/images/bg/ico_phone02.gif" alt="phone"><span>Tel: </span>02-767-6846 / 02-767-6847</div></li>
					<li><div><img src="/images/bg/ico_fax02.gif" alt="fax"><span>Fax: </span>02-724-7709</div></li>
				</ul>
			</section>
