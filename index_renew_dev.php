						...
						<li class="grid-item <?php echo $md_hide?>"  data-type="<?php echo $row['contentType']?>" data-idx="<?php echo $idx?>">
							<div class="inner type_<?php echo $row['contentType']?> <?php echo ($row['snsType']!='I') ? 'facebook' : 'instagram' ;?>">
								...
								<div class="cover">
						        	...
						        	<div class="hover">
						        		<div class="inner">
							        		<a href="<?php echo $row['hyperLink']?>" class="more"></a>
							        	</div>
						        	</div>
						      	</div>
							</div>
						...
						<li class="grid-item <?php echo $md_hide?>" data-type="<?php echo $row['contentType']?>" data-idx="<?php echo $idx?>" data-exhidx="<?php echo $row['exhibitionIdx']?>">
							<div class="inner type_galleries white">
								...
								<div class="cover">
						        	<div class="standard">
										<div class="inner">
											<p class="gallery"><?php echo $rowM['galleryNameKr']?></p>
						        	...
						        	<div class="hover">
						        		<div class="inner">
							        		<a href="/galleries/exhibitions/?at=read&idx=<?php echo $rowM['galleryIdx']?>&eidx=<?php echo $rowM['exhibitionIdx']?>" class="more"></a>
							        	</div>
						        	</div>
						      	</div>
							</div>
									...
									<div class="bx_link">
										<div class="inner" style="background-color: #fff;border-color:#23b400">
											<dl>
												...
												<dd>
													<p style="color:#999;">naver artwindo <br/>view all.</p>
												</dd>
											</dl>
										</div>
									</div>
