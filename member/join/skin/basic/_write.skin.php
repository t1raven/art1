...
<script src="/js/facebook-login.js"></script>
	  ...
	  <input type="hidden" name="mode" id="mode" value="join">
         ...
         <div class="bot_group">
             <div class="agreement">
             <p><input type="checkbox" name="policyAgree" id="policyAgree" class="inp {label:'이용약관',required:true}" placeholder="이용약관" required> 이용약관에 동의하시겠습니까? 약관 동의 내용을 보시려면 <a href="#" class="here">여기</a>를 클릭하세요</p>
             <p><input type="checkbox" name="privacyAgree" id="privacyAgree" class="inp {label:'개인정보취급방침',required:true}" placeholder="개인정보취급방침" required> 개인정보 취급방침에 동의하시겠습니까? 개입정보 취급방침 내용을 보시려면  <a href="#" class="here">여기</a> 클릭하세요</p>
            </div>
            <div class="btns">
