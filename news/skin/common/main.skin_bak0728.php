...
@media screen and (max-width: 639px){
	...
	#newWrapper .newsBox .newsBox_inner{padding-bottom:10px;}
	#newWrapper .newsBox .newsBox_inner .news_cont{margin-top:10px;padding-left:0px;}
	#newWrapper .newsBox .newsBox_inner .news_cont > h1{font-size:14px;display:inline;margin-right:5px;}
	#newWrapper .newsBox .newsBox_inner .news_cont > h2{margin-top:0px;display:inline;letter-spacing:-0.5px;}
	#newWrapper .newsBox .newsBox_inner .news_cont > h2 a{font-size:14px;line-height:16px;font-weight:400;}
	#newWrapper .newsBox .newsBox_inner .news_cont .text_cont{margin-top:10px;text-align:right;margin-bottom:0px;}
	#newWrapper .newsBox .newsBox_inner .news_cont .text_cont > p{display:inline;}
	#newWrapper .newsBox .newsBox_inner .news_cont .news_date{display:none;}
}
</style>
		  ...
		  <div class="sec1 content-mediaBox margin1">
              <div class="brief">
                <div class="bbs_thumb_t6">
                      <section class="lst">
                          <div class="thumb">
                              <a href="?at=read&subm=1&idx=<?php echo $News->attr['news_idx']; ?>"><img src="<?php echo newsUploadPath.$News->attr['news_main_up_file_name'];?>" alt="" /></a>
                          </div><!-- trend_imgBox -->
                          <div class="cont">
                              <div class="inner">
