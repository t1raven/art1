...
var article3Top =  $('#sect1').offset().top;
                   ...
                   success : function(data) {
                        var $container2;
                          ...
                          function onAlways( instance ) {
                            ...
                            //$container.find("li").css("opacity",1);
  ...
  // half4 = article4Top - 100;
   half5 = article5Top - 370;
    $("#sideNav").on("mouseenter mouseleave",function(e){
        ...
        $('html,body').animate({scrollTop:$(this.hash).offset().top-70}, 1500, 'easeInOutQuint');
    });
