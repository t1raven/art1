  ...
  var dt_mobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
...
var winsetTime;
var article1Top =  0;
var article2Top =  $('#sect1').offset().top;
...
var autoSlide = false;
      ...
      clearInterval(winsetTime);
        ...
        winsetTime = setTimeout(function(){
          if( top > article1Top && top < 399 ){
            ...
            $("html , body").stop().animate({scrollTop:article1Top},700,"easeInOutQuint",function(){autoSlide= false;}); 
            //con("최상단:::::::"+article1Top);
          }
          else if( top > 400  && top < article3Top - 399  ){
              $("html , body").stop().animate({scrollTop:article2Top-70},700,"easeInOutQuint",function(){autoSlide= false;}); 
 ...
 //         else if( top > article3Top - 400 && top < article4Top - 399 ){
     ...
     //     }
              ...
              $("html , body").stop().animate({scrollTop:article3Top-70},700,"easeInOutQuint",function(){autoSlide= false;}); 

                //con("award:::::::"+article4Top);
          }
           else if( top > article5Top - 400 && top < article6Top - 399 ){
              $("html , body").stop().animate({scrollTop:article5Top-70},700,"easeInOutQuint",function(){autoSlide= false;}); 
              //con("preview:::::::"+article5Top);
          }  

          else if( top > article6Top - 400){
              $("html , body").stop().animate({scrollTop:article6Top-70},700,"easeInOutQuint",function(){autoSlide= false;}); 
...
// 사이드 이동 및 고정 함수
 function sideOver2(){
	...
	var sideNav = $("#sideNav_v2 > .bx_dial > ul > li");
	
     if( _currentScrollTop >= 0 &&  _currentScrollTop < article2Top - halfOri ){
          if(!article1TopFlag && !sideNav.eq(0).hasClass('focus0') && scrollMotionFlag){
          	asideFn.move(0, "abs");
          }
        ...
        if( _currentScrollTop > article2Top - halfOri &&  _currentScrollTop < article3Top - halfOri ){
          if(!article2TopFlag && !sideNav.eq(1).hasClass('focus0') && scrollMotionFlag){
          	asideFn.move(1, "abs");
          }
        ...
        if( _currentScrollTop > article3Top - halfOri &&  _currentScrollTop < article5Top - halfOri ){
          if(!article3TopFlag && !sideNav.eq(2).hasClass('focus0') && scrollMotionFlag){
          	asideFn.move(2, "abs");
          }
          article1TopFlag = false;
          article2TopFlag = false;
       ...
       if( _currentScrollTop > article5Top - halfOri &&  _currentScrollTop < article6Top - halfOri ){
         if(!article5TopFlag && !sideNav.eq(3).hasClass('focus0') && scrollMotionFlag){
          	asideFn.move(3, "abs");
          }
          article1TopFlag = false;
          article2TopFlag = false;
        ...
        if( _currentScrollTop > article6Top - halfOri ){
         if(!article6TopFlag && !sideNav.eq(4).hasClass('focus0') && scrollMotionFlag){
          	asideFn.move(4, "abs");
          }
          article1TopFlag = false;
          article2TopFlag = false;
  ...
  o.each(function(){
    ...
    function mobileTouch(){
      ...
      if(cover.css("display") == "none"){
      	  var sib = $("#sect1 .lst_mov > .lst > li.on, #sect1 .m_tlie.on");
      	  sib.removeClass("on");
      	  fadePlayMotion(sib.find(".play") , false , speed);
	      fadePlayMotion(sib.find(".share") , false , speed);
	      fadePlayMotion(sib.find(".cover") , false , speed);
	      sib.find(".cont").stop().animate({"margin-top":-80},speed,"easeOutCubic");
    ...
    }else{$this.on("click",mobileTouch);}
             ...
             function prevMotion(){
                if(!$container_cen.parent().is(":animated")){
                   ...
                   // if($container_cen.offset().left < $(".Archive_inner").offset().left){
                        ...
                        $container_cen.parent().stop().animate({"left": "+="+(move * exposure)  },300,function(){
...
//이미지 리사이징
iCutter("#NewsV2 .Broad_inner .show > ul > li > .item");
//절사
dotWindow("#NewsV2 .Broad_inner .show > ul > li > .cont h2 , #NewsV2 .Broad_inner .lst_show > div.lst ul > li > .cont p a.ti" , "window");
//뉴스
//newsZone();   
//마켓
marketZone();
...
win.resize(function(){
  ...
  mainTimeOutSet = setTimeout(function(){
      iCutterLoadNone("#NewsV2 .Broad_inner .show > ul > li > .item");
