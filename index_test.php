...
<nav id="sideNav_v2" style="display: none;">
	<div class="bx_dial">
		<ul>
...
$movies[0]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[0]['num'].'.jpg';
$movies[1]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[1]['num'].'.jpg';
$movies[2]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[2]['num'].'.jpg';
$movies[3]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[3]['num'].'.jpg';
$movies[4]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[4]['num'].'.jpg';
$movies[5]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[5]['num'].'.jpg';
$movies[6]['img'] =  '/images/main/'.$imgVer.'/img_mov_'.$movies[6]['num'].'.jpg';

$movies[0]['mov'] =  'ArtistRec'.$movies[0]['num'];
$movies[1]['mov'] =  'ArtistRec'.$movies[1]['num'];
$movies[2]['mov'] =  'ArtistRec'.$movies[2]['num'];
$movies[3]['mov'] =  'ArtistRec'.$movies[3]['num'];
$movies[4]['mov'] =  'ArtistRec'.$movies[4]['num'];
$movies[5]['mov'] =  'ArtistRec'.$movies[5]['num'];
$movies[6]['mov'] =  'ArtistRec'.$movies[6]['num'];

/*$movies[0]['dimg'] =  '/images/bg/bg_mov_noPlay14.jpg';
$movies[1]['dimg'] =  '/images/bg/bg_mov_noPlay15.jpg';
$movies[2]['dimg'] =  '/images/bg/bg_mov_noPlay16.jpg';
$movies[3]['dimg'] =  '/images/bg/bg_mov_noPlay17.jpg';
$movies[4]['dimg'] =  '/images/bg/bg_mov_noPlay18.jpg';
$movies[5]['dimg'] =  '/images/bg/bg_mov_noPlay19.jpg';
$movies[6]['dimg'] =  '/images/bg/bg_mov_noPlay20.jpg';*/
?>
		  ...
		  <h1 class="title_main">
			...
			<section class="new_mov">
				<ul class="inner clearfix">
					<li class="bx_l">
						<div class="m_tlie tile_t1" data-video="<?=$movies[6]['mov']?>" data-idx="<?=$movies[6]['num']?>">
						...
						<ul class="clearfix">
							<li class="m_tlie tile_t2" data-video="<?=$movies[4]['mov']?>" data-idx="<?=$movies[4]['num']?>">
							...
							<li class="m_tlie tile_t2" data-video="<?=$movies[3]['mov']?>" data-idx="<?=$movies[3]['num']?>">
					...
					<li class="bx_r">
						<ul class="clearfix">
							<li class="m_tlie tile_t3" data-video="<?=$movies[2]['mov']?>" data-idx="<?=$movies[2]['num']?>">
							...
							<li class="m_tlie tile_t3" data-video="<?=$movies[1]['mov']?>" data-idx="<?=$movies[1]['num']?>">
							...
							<li class="m_tlie tile_t3 promo" data-video="<?=$movies[0]['mov']?>" data-idx="<?=$movies[0]['num']?>">
						...
						<div class="m_tlie tile_t4" data-video="<?=$movies[5]['mov']?>" data-idx="<?=$movies[5]['num']?>">
...
<!-- 기존 동영상 섹션 시작-->
          <div class="mov bxsh">
            ...
            <section class="lst_mov">
              ...
              <ul class="lst">
                  <li class="bxsh"  data-video="<?=$movies[5]['mov']?>" data-idx="<?=$movies[5]['num']?>">
                      <span class="cover"></span><img src="<?=$movies[5]['img']?>" class="movimg" alt="">
                      <div class="cont">
                  ...
                  <li class="bxsh"  data-video="<?=$movies[4]['mov']?>" data-idx="<?=$movies[4]['num']?>">
                      <span class="cover"></span><img src="<?=$movies[4]['img']?>" class="movimg" alt="">
                      <div class="cont">
                  ...
                  <li class="bxsh" data-video="<?=$movies[3]['mov']?>" data-idx="<?=$movies[3]['num']?>">
                      <span class="cover"></span><img src="<?=$movies[3]['img']?>" class="movimg" alt="">
                      <div class="cont">
                  ...
                  <li class="bxsh" data-video="<?=$movies[2]['mov']?>" data-idx="<?=$movies[2]['num']?>">
                      <span class="cover"></span><img src="<?=$movies[2]['img']?>" class="movimg" alt="">
                      <div class="cont">
                  ...
                  <li class="bxsh" data-video="<?=$movies[1]['mov']?>" data-idx="<?=$movies[1]['num']?>">
                      <span class="cover"></span><img src="<?=$movies[1]['img']?>" class="movimg" alt="">
                      <div class="cont">
                  ...
                  <li class="bxsh" data-video="<?=$movies[0]['mov']?>" data-idx="<?=$movies[0]['num']?>">
                      <span class="cover"></span><img src="<?=$movies[0]['img']?>" class="movimg" alt="">
                      <div class="cont">
						<!-- <h2 class="type2"><span>art1<br />&nbsp;show&nbsp;</span></h2> -->
						<h2><span>ARTIST<br />REC#<?=$movies[0]['num']?></span></h2>
		...
		function fullSize(){
              ...
              function itemMotion(num, endedFlag, me){
                 ...
                 var movBox = $("#sect1");
                  ...
                  console.log(num);
                  if(endedFlag){
              		var soundSrc = 'ArtistRec'+num;
                  }else{
                    var soundSrc = ele.data('video');
                  }

                  <? if($check_mobile === false){ ?>
                  var videobox = $('<video id="'+videoTag+'" '+ "autoplay" +' controls volume="1"  ></video>');
                  <? }else{ ?>
                  var videobox = $('<div class="video_cover" style=""></div><video id="'+videoTag+'" '+ "autoplay" +' controls volume="1"  ></video>');
                  <? } ?>
