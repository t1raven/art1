...
class AddressBook
{
	...
	function insert($dbh) {
		try {
			...
			$user_add_1 = $this->getAddslashes('user_add_1');
			$user_add_2 = $this->getAddslashes('user_add_2');
			...
			$stmt->bindParam(':user_add_1', $user_add_1, PDO::PARAM_STR, 100);
			$stmt->bindParam(':user_add_2', $user_add_2, PDO::PARAM_STR, 100);
	...
	function update($dbh) {
		try {
			...
			$sql = ' UPDATE member_orders_addr
						SET user_name = :user_name, user_zip = :user_zip, user_addr_1 = :user_addr_1, user_addr_2 = :user_addr_2, user_email = :user_emil, user_tel = :user_tel, default_state = :default_state
