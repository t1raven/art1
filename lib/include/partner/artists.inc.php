<?php if (!defined('OKTOMATO')) exit; ?>
			...
			<section id="bannerListPopup" class="layer_popup2">
				<header class="searchBox">
					<input type="text" class="inp_txt w190 searchPopup" name="artist" id="artist" placeholder="작가명을 입력하세요." onkeypress="if(event.keyCode==13){searchArtist();return false;}">
				...
				<div class="align_right">
					<button type="button" class="btn_pack1 ov-b small rato" onclick="insertArtist();">Save</button>
