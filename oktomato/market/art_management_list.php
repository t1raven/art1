               ...
               <table summary="참가자 관리의 결과 대한(all, 접수번호, 이름, 소속기관, 입금확인, 결제수단, 등록일, 등록취소) 정보를 확인하는 표">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>A292345</td>
                        <td ><a href="art_management_view.php">에코백</a></td>
                        <td class="name">홍길동</td>
                        <td class="fc1">2014.07.24</td>
                        <td>
                           <div class="user_td_control1">
                              <button onClick="location.href='art_management_view.php'">수정</button>
                              <button>삭제</button>
                           </div>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td>A292345</td>
                        <td ><a href="art_management_view.php">엠블램 우산</a></td>
                        <td class="name">박진아</td>
                        <td class="fc1">2014.07.24</td>
                        <td>
                           <div class="user_td_control1">
                              <button onClick="location.href='art_management_view.php'">수정</button>
