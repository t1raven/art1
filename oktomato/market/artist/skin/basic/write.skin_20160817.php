                   ...
                   <tbody>
                      ...
                      <tr>
                         ...
                         <td >
                            ...
                            <input name="first_name" type="text" class="inp_txt lh w60" id="first_name" value="<?php echo $aArtistEnName[0];?>" title="First Name 입력">
                            </span>
                            <span class="col_td auto">
                            <label for="last_name" class="pos">Last Name</label>
                            <input name="last_name" type="text" class="inp_txt lh w60" id="last_name" value="<?php echo $aArtistEnName[1];?>" title="Last Name 입력">
                            </span>
                         </td>
                      </tr>
                      <tr>
                    ...
                    <?php for($i=0; $i<3; $i++){$p=$i+1;?>
                     ...
                     <tr>
                        ...
                        <td >
                          ...
                          <input name="cv_name[]" type="text" class="inp_txt w390" id="" value="<?php echo $aCvName[$i];?>" title="CV 프로젝트 <?php echo $p.numberOrdering($p);?> 입력">
                        </td>
                     </tr>
                     <?php }?>
               ...
               <table summary="작가 등록(작가명 및 사진 ,학령 등을 입력하는 표)">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td colspan="2">
                           <div class="textarea">
                              <textarea name="greeting" id="greeting"><?php echo stripslashes($Artist->attr['artist_greeting']);?></textarea>
                           </div>
