               ...
               <table summary="작가 등록(작가명 및 사진 ,학령 등을 입력하는 표)">
                ...
                <?php for($i=0; $i<5; $i++): ?>
                     ...
                     <tr>
                        ...
                        <th scope="row"><input name="artwork_year[]" type="text" class="inp_txt w50 only_number" value="<?php echo $aAnnualArtworkYear[$i]; ?>" maxlength="4" placeholder="연도"></th>
                        <td><input name="artwork_cnt[]" type="text" class="inp_txt w50 only_number" value="<?php echo $aAnnualArtworkCnt[$i]; ?>" maxlength="4" placeholder="전시수"></td>
                     </tr>
                     <?php else:?>
                     <tr>
                        <th scope="row"><input name="artwork_year[]" type="text" class="inp_txt w50 only_number" value="<?php echo $aAnnualArtworkYear[$i];?>" maxlength="4" placeholder="연도"></th>
