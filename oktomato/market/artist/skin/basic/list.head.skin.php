              ...
              <tr>
                ...
                <td class="colbox">
                  <span class="col_td auto">
                    <label for="nm" class="pos">작가명(Kr)</label>
                  ...
                  <span class="col_td auto">
                    <label for="enm" class="pos">작가명(En)</label>
                    <input name="enm" type="text" class="inp_txt lh w90" id="enm" value="<?php echo $enm;?>">
                  </span>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  <div class="resetBox">
                    ...
                    <?php if (!empty($enm)):?><span class="searchtag" id="span-enm"><?php echo $enm;?><button type="button" onclick="deleteKeyword('enm');">삭제</button></span><?php endif;?>
        ...
        <section class="bbsTop">
          ...
          <div class="group_rgh">
             <p class="sort">
              ...
              <button type="button" onclick="setOrder(0, <?php echo ($od === 1) ? 0:1;?>)"<?php if($sort === 0):?> class="on"<?php endif;?>>등록일순</button> / <button onclick="setOrder(1, <?php echo ($od === 1) ? 0:1;?>)"<?php if($sort === 1):?> class="on"<?php endif;?>>작가명순</button>
            </p>
            <p class="align">
