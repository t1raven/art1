...
require_once('../../lib/class/work/work.class.php');
...
<form name="searchFrm" method="get">
	...
	검색어	<input type="text" name="wnm" value="" placeholder="작품명">
	...
	<input type="text" name="nm" value="" placeholder="작가명">
...
<tr>
	<td><input type="checkbox" name="idxs[]" value="<?php echo($row['work_idx']);?>"></td>
	<td><?php echo($PAGE_UNCOUNT);?></td>
	<td><?php echo($row['artist_name']);?></td>
	<td><?php echo($row['work_name']);?></td>
	<td><?php echo($row['create_date']);?></td>
	<td>
		<a href="?at=write&idx=<?php echo $row['work_idx'];?>&page=<?php echo $page?>&mode=edit">수정</a>
		<a href="javascript:void(0);" onclick="deleteArticle(<?php echo $row['work_idx'];?>);">삭제</a>
	</td>
</tr>
<?php
	$PAGE_UNCOUNT --;
