 ...
 <section id="container">
  <div class="container_inner">
    ...
    <?php include '../../inc/datepicker_setting.php'; ?>
     ...
     <input type="hidden" name="goods_cnt" id="goods_cnt" value="<?php echo $Work->attr['goods_cnt'];?>">
	 ...
	 <input type="hidden" name="scale_img" id="scale_img" value="<?php echo $Work->attr['goods_scale_img'];?>"><!--스케일 이미지 작업-->
            ...
            <table summary="Category">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="lst_check checkbox colorBar">
                      <?php for($i=0; $i<$colorCnt; $i++):?>
                      <span class="aColor<?php echo $i+1;?>">
                        <label for="color<?php echo $i;?>"><?php echo $aColor[$i]?></label>
                        <!-- <input type="checkbox" name="color[]" id="color<?php echo $i;?>" value="<?php echo $i;?>"<?php if ($Work->attr['goods_color'] === (string)$i):?> checked<?php endif;?>> -->
                        <input type="checkbox" name="color[]" id="color<?php echo $i;?>" value="<?php echo $i;?>"<?php if (strpos($Work->attr['goods_color_multi'], '§'.(string)$i.'§') !== false):?> checked<?php endif;?>>
                      </span>
                      <?php endfor;?>
                    </div>
                  </td>
        ...
        <div class="lst_table3">
            <table summary="Main Info.">
              ...
              <tbody>
                  ...
                  <td>
                    <div class="lst_check radio">
                      ...
                      <span>
						...
						<?php //2016-04-27 업체 요청 - 프레임 기본 non-framed LYT ?>
						<input type="radio" name="frame_state" id="frame_state2" value="N"<?php if ($Work->attr['goods_frame_state'] === 'N' || empty($Work->attr['goods_frame_state'])  ):?> checked<?php endif;?>>
                      </span>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <span class="col_td auto">
                      ...
                      <input name="depth_size" type="text" class="inp_txt lh w110 only_number_dot {label:'세로 사이즈',required:true}" id="depth_size" value="<?php echo $Work->attr['goods_depth'];?>">
                    </span>
                    X
                    <span class="col_td auto">
                      <label for="width_size" class="pos">가로</label>
                      <input name="width_size" type="text" class="inp_txt lh w110 only_number_dot {label:'가로 사이즈',required:true}" id="width_size" value="<?php echo $Work->attr['goods_width'];?>">
                    </span>
                    X
                    <span class="col_td auto">
                      <label for="height_size" class="pos">높이</label>
                      <input name="height_size" type="text" class="inp_txt lh w110 only_number_dot {label:'높이',required:true}" id="height_size" value="<?php echo $Work->attr['goods_height'];?>">
                    </span>
                ...
                <tr>
                  <th scope="row">판매 가격 대체문구 </th>
                  <td>
                    <input class="inp_txt w390" name="price_exchange_text" id="price_exchange_text" type="text" value="<?php echo $Work->attr['price_exchange_text'];?>"<?php if ($Work->attr['price_exchange_state'] !== "Y"): ?>  disabled<?php endif; ?>>
                    <span class="ml15"><input type="checkbox" name="price_exchange_state" id="price_exchange_state" value="Y" onclick="disabledText('S');"<?php if ($Work->attr['price_exchange_state'] === "Y"): ?> checked<?php endif; ?>><span class="ml15">판매 가격 대체문구 사용</span></span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="lst_check radio">
                      <span>
                        <label for="sold_out_state1">Yes</label>
                        <input type="radio" name="sold_out_state" id="sold_out_state1" value="Y" onclick="setGoodsCount('0');" <?php if ($Work->attr['sold_out_state'] === 'Y'):?> checked<?php endif;?>>
                      </span>
                      <span>
                        <label for="sold_out_state2">No</label>
                        <input type="radio" name="sold_out_state" id="sold_out_state2" value="N" onclick="setGoodsCount('1');"<?php if ($Work->attr['sold_out_state'] === 'N'):?> checked<?php endif;?>>
                      </span>
                    </div>
                  </td>
                </tr>
			   ...
			   ?>
                ...
                <tr>
                  ...
                  <td>
                    <input name="rental_price" type="text" class="inp_txt w110" value="<?php echo $Work->attr['goods_rental_price'];?>">
                    <span class="ml15">cf. 원단위 입력</span>
                  </td>
                </tr>
                <tr>
                  <th scope="row">렌탈 가격 대체문구 </th>
                  <td>
                    <input class="inp_txt w390" name="rental_exchange_text" id="rental_exchange_text" type="text" value="<?php echo $Work->attr['rental_exchange_text'];?>"<?php if ($Work->attr['rental_exchange_state'] !== "Y"): ?>  disabled<?php endif; ?>>
                    <span class="ml15"><input type="checkbox" name="rental_exchange_state" id="rental_exchange_state" value="Y" onclick="disabledText('R');"<?php if ($Work->attr['rental_exchange_state'] === "Y"): ?> checked<?php endif; ?>><span class="ml15">렌탈 가격 대체문구 사용</span></span>
                  </td>
                </tr>
                <tr>
                  <th scope="row">렌탈 여부 *</th>
                  <td>
                    <div class="lst_check radio">
                      <span>
                        <label for="is_rental1">Yes</label>
                        <input type="radio" name="is_rental" id="is_rental1" value="Y"<?php if ($Work->attr['is_rental'] === 'Y'):?> checked<?php endif;?>>
                      </span>
                      <span>
                        <label for="is_rental2">No</label>
                        <input type="radio" name="is_rental" id="is_rental2" value="N"<?php if ($Work->attr['is_rental'] === 'N'):?> checked<?php endif;?>>
                      </span>
                    </div>
                  </td>
                </tr>
                <tr>
                  <th scope="row">렌탈 메모</th>
                  <td>
                    <div class="textarea">
                      <textarea name="rental_memo"><?php echo $Work->attr['rental_memo'];?></textarea>
                    </div>
                  </td>
                </tr>
				-->
				...
				<!-- tr>
                  <th scope="row">사이즈 비교를 위한 이미지</th>
                  <td>
                      <input name="referee" type="text" class="inp_txt w190 searchPopup" id="referee" value="<?php echo $Work->attr['referee'];?>"  readonly>
                      <a href="#RecommendedListPopup" class="searchPopup layerOpen"><img src="/oktomato/images/btn/btn_search_off.jpg" alt="검색" class="btnOvr"></a>
                  </td>
			  ...
			  <tr>
                <th scope="row">사이즈 비교를 위한 이미지<br>(394 * 260)</th>
                <td>
                  <div class="clearfix">
                    <div class="fileinputs" >
                      <span style="background:#ddd; display:inline-block;"><img id="goodsImg999" src="<?php if (!empty($Work->attr['goods_scale_img'])): echo goodsScaleImgUploadPath, $Work->attr['goods_scale_img']; endif;?>" width="132" height="100" alt="이미지를 업로드해주세요."></span>
                      <button type="button" id="btn_regist999"  class="btn_regist">이미지 등록</button>
                      <button type="button" id="btn_delete999" class="btn_delete" onclick="deleteScaleImg();">이미지 삭제</button>
                      <div id="upload_status999" style="display:none;">
            ...
            <table summary="Sub Info.">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="textarea">
                      <textarea name="description"><?php echo stripslashes($Work->attr['goods_description']);?></textarea>
                    </div>
                  </td>
                </tr>
                <tr>
        ...
        <div class="lst_table3">
          <table summary="Search Option ImageUpload">
            ...
            <tbody>
              <tr>
                <th scope="row">주의</th>
                <td>dpi는 72dpi. 가로사이즈 min 1300 ~ max 1920px 까지 가능. Jpg만 허용. 각 슬롯 파일 크기는 1MB 제한. <br>List Image는 258px X 299px 사이즈로 업로드.</td>
              </tr>
             <tr>
...
$(function(){
	...
	//사이즈 비교를 위한 이미지 처리
	var button = $("#btn_regist999"), interval;
	new AjaxUpload(button,{
		action: 'upload.php?<?php echo PageUtil::_param_get('');?>',
		name: 'scale_file',
		onSubmit : function(file, ext){
			this.disable();
			$("#upload_status999").css("display", "block");
		},
		onComplete: function(file, response){
			console.log("sss");
			$("#upload_status999").css("display", "none");
			var result = $.trim(response).split("|");
			var status = result[0];
			if (status == "__complete"){
				var filename = result[1];
				$("#btn_regist999").css("display","none");
				$("#btn_delete999").css("display","inline");
				$("#scale_img").val(filename);
				$("#goodsImg999").attr("src","/upload/goods/scale/" + filename);
			}
			else if (status == "__large"){
				alert("1Mbyte 이하인 이미지를 선택하세요.");
			}
			else{
				alert(status+" [jpg]파일을 선택하세요.");
			}
			this.enable();
		}
	});
...
function deleteScaleImg() {
	$("#btn_regist999").css("display","inline");
	$("#btn_delete999").css("display","none");
	$("#scale_img").val("");
	$("#goodsImg999").attr("src","");
}
...
function disabledText(v){
	if (v == "S"){
		$("#price_exchange_text").attr("disabled", !$("input:checkbox[id='price_exchange_state']").is(":checked"));
		$("#price_exchange_text").val("");
	}
	else {
		$("#rental_exchange_text").attr("disabled", !$("input:checkbox[id='rental_exchange_state']").is(":checked"));
		$("#rental_exchange_text").val("");
	}
}

function setGoodsCount(n) {
	$("#goods_cnt").val(n);
}
</script>
