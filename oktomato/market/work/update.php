...
$goods_scale_img = isset($_POST['list_img']) ? Xss::chkXSS($_POST['scale_img']) : null;

$price_exchange_text = isset($_POST['price_exchange_text']) ? Xss::chkXSS($_POST['price_exchange_text']) : null;
$price_exchange_state = isset($_POST['price_exchange_state']) ? Xss::chkXSS($_POST['price_exchange_state']) : 'N';
$rental_exchange_text = isset($_POST['rental_exchange_text']) ? Xss::chkXSS($_POST['rental_exchange_text']) : null;
$rental_exchange_state = isset($_POST['rental_exchange_state']) ? Xss::chkXSS($_POST['rental_exchange_state']) : 'N';

//2016-05-20 LYT
// 색상 멀티 처리
if( !empty($goods_color) ) {
	$goods_color = '§'.implode('§',$goods_color).'§';
}


$is_rental = isset($_POST['is_rental']) ? Xss::chkXSS($_POST['is_rental']) : 'N';
$rental_memo = isset($_POST['rental_memo']) ? Xss::chkXSS($_POST['rental_memo']) : null;
...
$Work->setAttr('goods_scale_img', $goods_scale_img);

$Work->setAttr('price_exchange_text', $price_exchange_text);
$Work->setAttr('price_exchange_state', $price_exchange_state);
$Work->setAttr('rental_exchange_text', $rental_exchange_text);
$Work->setAttr('rental_exchange_state', $rental_exchange_state);

$Work->setAttr('is_rental', $is_rental);
$Work->setAttr('rental_memo', $rental_memo);
