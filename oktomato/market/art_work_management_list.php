              ...
              <tr>
                ...
                <td class="colbox">
                  <span class="col_td auto">
                    <label for="art" class="pos">주문작품명</label>
                    <input name="tit" type="text" class="inp_txt lh w90" id="art" value=""> 
                    <button type="button" class="btn_switch">AND</button>
                  </span>
                  <span class="col_td auto">
                    <label for="mn" class="pos">주문자명</label>
              ...
              <tr>
                ...
                <td>
					<div class="lst_check radio">
                      ...
                      <span>
                        <label for="frame2">주문접수</label>
                        <input type="radio" name="frame" id="frame2">
                      </span>
                      <span>
                        <label for="frame3">입금완료</label>
                        <input type="radio" name="frame" id="frame3">
                      </span>
					  <span>
                        <label for="frame4">상품준비</label>
                        <input type="radio" name="frame" id="frame4">
                      </span>
					  <span>
                        <label for="frame5">배송 중</label>
                        <input type="radio" name="frame" id="frame5">
                      </span>
					  <span>
                        <label for="frame6">배송완료</label>
              ...
              <tr>
                ...
                <td>
                  <div class="user_td_control1">
                    <button onClick="location.href='art_work_management_view.php'">수정</button>
                    <button>삭제</button>
                  </div>
                </td>
              </tr>
