		<table border="0" cellspacing="0" cellpadding="0" class="upload_tab" >
			<tr>
				...
				<td style="vertical-align: top;">
					...
					<div class="upload_div" >
						<!--<a onclick="bbsAttachFile();" style="cursor:pointer;"><img src="/images/container/but_sfile.gif" width="63" height="20" border="0" alt="파일첨부"></a>-->
						<a onclick="allDelFileList();" style="cursor:pointer;"><img src="/images/container/but_delall.gif" width="63" height="20" border="0" alt="전체삭제"></a>
						<br><span class="text">파일: </span><span id="nowMB" class="text2">0MB</span><span class="text">/<?=$BBS_UPLOAD_SIZE;?> MB</span>
					</div>
					<table border="1" cellspacing="0" cellpadding="0" class="upload_tab4" >
						<tr>
							<td width="98%" class="file_content6">
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0" >
												<tr>
													<td>
														...
														<?php if (is_array($aFileInfo)) : ?>
															<?php foreach($aFileInfo as $fileInfo): ?>
															<option value="<?=$fileInfo['upfile_idx'];?>|<?=$fileInfo['ori_file_name'];?>|<?=$fileInfo['up_file_name'];?>|<?=$fileInfo['file_size'];?>|<?=$fileInfo['file_type'];?>"><?=$fileInfo['ori_file_name'];?> (<?=($fileInfo['file_size'] / 1024);?> KB)</option>
															<?php endforeach; ?>
														<?php endif ; ?>
														</select>
													</td>
