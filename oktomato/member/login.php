...
<!-- script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script --> <!--익스8에서 에러발생 버전 낮춤 //by 이용태-->
...
<body>
 ...
 <section id="loginBoxArea">
  <h1><img src="/oktomato/images/login/txt_login.jpg" alt="아트홍" /></h1>
  <div class="blueBox">
   <p>Administrate Mode</p>
   <div class="flid">
     ...
     <div class="id_box"> <input type="text" name="uid" class="inp {label:'아이디',required:true}" placeholder="ID" required></div>
      <div class="pw_box"><input type="password" name="upwd" class="inp {label:'비밀번호',required:true}" placeholder="Password" required></div>
