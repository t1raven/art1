          ...
          <table summary="작가 검색">
            ...
            <tbody>
			  ...
			  <tr>
                ...
                <td>
                  <div class="resetBox">
                      <button type="button"  class="btn_pack1 ov-b gray small rato"  onclick="location.href='?at=excel_download';">다운로드</button>
                  </div>
                </td>
              </tr>
            </tbody>
        ...
        <section class="bbsTop">
          ...
          <div class="group_rgh">
			 ...
			 <strong><img src="<?php echo $currentFolder;?>/images/bg/bg_list2_<?php echo ($od === 0) ? 'off' : 'on';?>.jpg" alt="정렬"></strong>
              ...
              / <button onclick="setOrder(1, <?php echo ($od === 1) ? 0:1;?>)"<?php if($sort === 1):?> class="on"<?php endif;?>>이메일순</button>
            </p> 
            <p class="align">
