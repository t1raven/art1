...
<? include "../inc/side.php"; ?>
              ...
              <tr>
                ...
                <td class="colbox">
                  <span class="col_td auto">
                    <label for="mail" class="pos">이메일</label>
                    <input name="mail" type="text" class="inp_txt lh w90" id="mail" value=""> 
                  </span>
          ...
          <table summary="참가자 관리의 결과 대한(all, 접수번호, 이름, 소속기관, 입금확인, 결제수단, 등록일, 등록취소) 정보를 확인하는 표">
            ...
            <tbody>
              <tr>
                ...
                <td>4</td>
                <td class="name"><a href="#" class="fc_blue td-u">abc@oktomato.net</a></td>
               	<td>2014.07.24</td>
                <td>
 ...
 <section id="mainInfoPopup" class="layer_popup1">
   ...
   <article class="cont">
      <h1>뉴스레터 신청 이메일</h1>
       <p> <input name="" type="text" class="inp_txt w190" id="" value="abc@oktomato.net" > <button onclick="alert('준비중입니다.');" class="btn_pack1 ov-b small rato">Save</button></p>
   </article>
</section>
<script>
   $(function(){
