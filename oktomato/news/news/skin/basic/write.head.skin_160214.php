 ...
 <section id="container">
  <div class="container_inner">
    ...
    <? include "../../inc/datepicker_setting.php"; ?>
	 ...
	 <input type="hidden" name="old_news_recent_up_file_name" id="news_recent_up_file_name" value="<?php echo $News->attr['news_recent_up_file_name'] ;?>">
	 <input type="hidden" name="old_news_recent_ori_file_name" id="news_recent_ori_file_name" value="<?php echo $News->attr['news_recent_ori_file_name'] ;?>">
							...
							<td >
							  <div class="photoUpload">
								...
								<div class="cont clearfix">
									...
									<p>* (<span id="span_img_size_text">698px * 300px / PC용 와이드 이미지 입니다.</span>) 1MB제한.</p>
									
								  <div class="fileinputs" >
									<input type="file" class="file" name="imgRecentFile" />
								  </div>
								  <div class="lst_Upload">
