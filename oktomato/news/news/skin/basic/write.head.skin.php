 ...
 <section id="container">
  <div class="container_inner">
    ...
    <? include "../../inc/datepicker_setting.php"; ?>
	 ...
	 <input type="hidden" name="old_news_main_up_file_name" id="old_news_main_up_file_name" value="<?php echo $News->attr['news_main_up_file_name'] ;?>">
	 <input type="hidden" name="old_news_main_ori_file_name" id="old_news_main_ori_file_name" value="<?php echo $News->attr['news_main_ori_file_name'] ;?>">
	 <input type="hidden" name="old_news_recent_up_file_name" id="old_news_recent_up_file_name" value="<?php echo $News->attr['news_recent_up_file_name'] ;?>">
	 <input type="hidden" name="old_news_recent_ori_file_name" id="old_news_recent_ori_file_name" value="<?php echo $News->attr['news_recent_ori_file_name'] ;?>">
...
?>
								<span><label for="news_main">news main</label>
											...
											<?php if($newsCate1==1) { ?>
											<!-- <script>$(function(){$("#span_img_size_text").text("700px * 337px");});</script> -->
											<?php }?>
								</span>
								<br />
							</div>
...
<script>
		...
		<section class="section_box">
			...
			<div class="lst_table3">
				<table summary="뉴스 등록(작가명 및 사진 ,학령 등을 입력하는 표)">
					<caption>뉴스 등록</caption>
					<colgroup>
					  <col class="th1">
					  <col>
					</colgroup>
					<tbody id="tbodyP">
						...
						<tr>
							<th scope="row" >출처</th>
							<td >
							  <input name="source" type="text" class="inp_txt w390" id="source" value="<?php echo (empty($source))? '아트1' : $source ;?>" title="출처 입력">
							</td>
						</tr>
						<tr>
						...
						<tr id="postCate" style="display:none">
							...
							<td >
							 <div class="lst_check radio">
								  ...
								  <select name="postCategory"  id="postCategory">
									...
									<option value="1" <?php echo $postCategory == '1'? 'selected': ''; ?> >아티스타</option>
									<option value="2" <?php echo $postCategory == '2'? 'selected': ''; ?>>ARS</option>
									<option value="3" <?php echo $postCategory == '3'? 'selected': ''; ?>>in Bbrief</option>
									<option value="4" <?php echo $postCategory == '4'? 'selected': ''; ?>>주전자</option>
								  </select>
								  <br> * 주간 처음은 반드시 [아티스타]가 등록되어야 합니다. 
								  <br> * [아티스타]가 등록된 주간을 기준으로 ARS/인브리프/주전자를 가져옵니다.
								  <br> * [아티스타]가 등록되지 않으면 해당 주간에 ARS/인브리프/주전자를 올려도 프론트에 노출되지 않습니다.
								</div>
							</td>
						</tr>
							...
							<td >
							  <div class="photoUpload">
								...
								<div class="cont clearfix">
									...
									<p>* (<span id="span_img_size_text">367px * 367px</span>) 1MB제한.</p>

								  <div class="fileinputs" >
									<input type="file" class="file" name="imgMainFile" id="imgMainFile" />
								  </div>
						...
						<tr id="newsmain_tr" >
							<th scope="row">Recent News <br>& News Main<br>(2:1) *</th>
							<td >
							  <div class="photoUpload">
								<div class="photo"><span id="span-view-img-recent"><?php if($News->attr['news_recent_up_file_name']) echo '<img src=\''.newsUploadPath.$News->attr['news_recent_up_file_name'].'\' width=112 >' ;?></span></div>
								<div class="cont clearfix">
									<p>
										<div class="lst_check radio">
										  <span>
											<label for="water_on_recent">워터마크 표시</label>
											<input type="radio" name="water_status_recent" id="water_on_recent"  value="Y" <?php if($water_status=='Y'  ){ echo 'checked';} ?>>
										  </span>
										  <span>
											<label for="water_off_recent">워터마크 안 함</label>
											<input type="radio" name="water_status_recent" id="water_off_recent" value="N" <?php if($display_status=='N'){ echo 'checked';} ?>>
										  </span>
										  <br>* 워터마크는 입력만 적용됩니다.  수정 시에는 해당 이미지를 삭제하고  다시 올린 후, 저장하면 워터마크 적용이 가능합니다.
										</div>
									</p>
									<p>* (<span id="span_img_size_text">700px * 350px / PC용 와이드 이미지 입니다.</span>) 1MB제한.</p>

								  <div class="fileinputs" >
									<input type="file" class="file" name="imgRecentFile" id="imgRecentFile"/>
								  </div>
								  <div class="lst_Upload">
									<?php		if(!empty($News->attr['news_recent_ori_file_name']) ){  ?>
									<span class="tag" id="span-img-recent"><?php echo $News->attr['news_recent_ori_file_name'] ;?>
										<button onclick="deleteRecentFile(<?php echo $News->attr['news_idx'] ;?>)">삭제</button>
									</span>
									<?php } ?>
								  </div>
								  <div class="lst_Upload">
