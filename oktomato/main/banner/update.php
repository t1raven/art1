...
$aBannerIdx				= isset($_POST['banner_idx']) ? $_POST['banner_idx'] : null;
$aNewsIdx				= isset($_POST['news_idx']) ? $_POST['news_idx'] : null;
$aNewsTitle				= isset($_POST['news_title']) ? $_POST['news_title'] : null;
$aNewsText				= isset($_POST['news_text']) ? $_POST['news_text'] : null;
$aCategoryIdx			= isset($_POST['category_idx']) ? $_POST['category_idx'] : null;
$aCategoryText		= isset($_POST['category_text']) ? $_POST['category_text'] : null;
$aNewsImg				= isset($_POST['news_img']) ? $_POST['news_img'] : null;
$aSection					= isset($_POST['section']) ? $_POST['section'] : null;
$aReporterName		= isset($_POST['reporter_name']) ? $_POST['reporter_name'] : null;
$aCreateDate			= isset($_POST['create_date']) ? $_POST['create_date'] : null;
...
$banner->setAttr('aBannerIdx', $aBannerIdx);
$banner->setAttr('aNewsIdx', $aNewsIdx);
$banner->setAttr('aNewsTitle', $aNewsTitle);
$banner->setAttr('aNewsText', $aNewsText);
$banner->setAttr('aCategoryIdx', $aCategoryIdx);
$banner->setAttr('aCategoryText', $aCategoryText);
$banner->setAttr('aNewsImg', $aNewsImg);
$banner->setAttr('aSection', $aSection);
$banner->setAttr('aReporterName', $aReporterName);
$banner->setAttr('aCreateDate', $aCreateDate);

$banner->setAttr('aMainBannerIdx', $aMainBannerIdx);
$banner->setAttr('aLinkUrl', $aLinkUrl);
$banner->setAttr('aBannerSection', '1');
