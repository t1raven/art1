...
$Badwords->setAttr("st", $st);
$Badwords->setAttr("word", $word);
$Badwords->setAttr("page", $page);
$Badwords->setAttr("sz", $sz);
$Badwords->setAttr("sort", $sort);
$Badwords->setAttr("od", $od);
$tmp = $Badwords->getList($dbh);
$list = $tmp[0];
$total_cnt = $tmp[1];
$total_all_cnt = $tmp[2];
