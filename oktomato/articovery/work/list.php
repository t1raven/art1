...
$params = ($sz > 10) ? 'st='.$st.'&nm='.$nm.'&gnm='.$gnm.'&sort='.$sort.'&od='.$od.'&sz='.$sz : 'at='.$at.'&st='.$st.'&nm='.$nm.'&gnm='.$gnm.'&sort='.$sort.'&od='.$od;

$paramsExcel = '?at=excel_download&sz=&st='.$st.'&gnm='.$gnm.'&nm='.$nm.'&bdate='.$bdate.'&edate='.$edate.'&sort='.$sort.'&od='.$od;
