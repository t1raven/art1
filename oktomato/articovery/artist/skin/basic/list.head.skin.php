        ...
        <section class="bbsTop">
          ...
          <div class="group_rgh">
             <p class="sort">
              ...
              <button type="button" onclick="setOrder(0, <?php echo ($od === 1) ? 0:1;?>)"<?php if($sort === 0):?> class="on"<?php endif;?>>등록일순</button> / <button onclick="setOrder(1, <?php echo ($od === 1) ? 0:1;?>)"<?php if($sort === 1):?> class="on"<?php endif;?>>PIN순</button>
            </p>
            <p class="align">
