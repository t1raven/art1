...
$exhibitionIdx						= isset($_POST['exhibitionIdx']) ? $_POST['exhibitionIdx'] : null;
...
$main->setAttr('exhibitionIdx', Xss::chkXSS($exhibitionIdx));
...
if ($arr_img['name']) {
	...
	if (!empty($oldContentUpFileName)) {
		...
		LIB_FILE::DeleteFile(ROOT.$row['upFileName']);
	}
