...
<section id="container_sub">
	<div class="container_inner">
		...
		<div id="area_gallery_index" class="content-mediaBox margin1">
			<div class="top_btn">
				<button class="btnWhiteEdge" onclick="location.href='/galleries/join_info.php/'">Join +</button>
			</div>
					...
					<ul class="swiper-wrapper">
						...
						<li class="swiper-slide">
							<a href="<?php echo $val['link']; ?>">
								<img src="<?php echo galleriesBannerUploadPath, $val['upfileName']; ?>" alt=""/>
				...
				<?php if ($totalCnt > 0 && is_array($list)) : ?>
					...
					<?php foreach ($list as $key => $row) : ?>
						<li>
							...
							<div class="con">
								<h4><?php echo $row['galleryNameEn']; ?></h4>
								<p><?php echo $row['addr1En']; ?></p>
							</div>
						</li>
						<?php if ($key === 8 || $key === 17 || $key === 26 || $key === 35 || $key === 44) : ?>
							<?php if (!empty($barbanner[$i]['upfileName'])) : ?>
								<li class="w3">
									<a href="<?php echo $barbanner[$i]['link']; ?>" target="_blank" class="banner"><img src="<?php echo galleriesBannerUploadPath, $barbanner[$i]['upfileName']; ?>" alt="" /></a>
								</li>
								<?php $i++; ?>
							<?php endif ; ?>
						<?php endif ; ?>
