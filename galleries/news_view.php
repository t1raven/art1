...
<section id="container_sub">
	<div class="container_inner">
		...
		<div id="area_gallery_news_view" class="content-mediaBox margin1">
          <section id="bbs_view_ty1">
              <div class="inner">
                  <header class="header">
                      <h1><strong>전시안내 </strong>정우성이 해설하는 미술전시가 있다?!</h1>
                      <p class="data">2014.10.14</p>
                  ...
                  <article class="content">
					...
					<ul class="ico_list">
						...
						<li><a href=""><img src="/images/bbs/ico_bbs_view2_off.gif" alt="" /></a></li>
						<li><a href=""><img src="/images/bbs/ico_bbs_view3_off.gif" alt="" /></a></li>
						<li><a href=""><img src="/images/bbs/ico_bbs_view4_off.gif" alt="" /></a></li>
						<li><a href=""><img src="/images/bbs/ico_bbs_view5_off.gif" alt="" /></a></li>
					</ul>
                  </article><!-- //content --> 
                  </header><!-- //header -->
	...
	$(this).find("img").attr("src",$(this).find("img").attr("src").split("_on").join("_off"));
          ...
          <div class="btn_bot">
              ...
              <div class="rgh_group">
                  <a href="news.php" class="btn_pack samll">목록</a>
              </div> 
          </div><!-- //btn_bot -->
