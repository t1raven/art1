              ...
              <!--
				...
				?>
                 ...
                 <ul>
                   ...
                   <li>
                       <div class="photo">
                            <a href="exhibitions.php?evt=11">
                                <img src="/upload/market/main/14252971973NZGFRLY6A.jpg" alt="" class="pc" >
                                <img src="/images/tmp/tmp_marketPromotion_2.jpg" alt="" class="mobile" >
                            </a>
                        </div>
                     </li>
                </ul>
...
var winWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
  ...
  function marketViewMotion(event){
    var boxView = $("<div></div>").addClass("boxView");
    var $this = $(this);

     if($container.find(".viewOn").length > 0){
       $container.find(".viewOn").removeClass('viewOn').find(".newsBox_inner").css("display","block").end().find(".boxView").remove();
      }
...
function filterAjaxChange(f){
  ...
  $container.off("click.motionView").on( 'click.motionView', '.newsBox',marketViewMotion);   
    ...
    $(".sort_lst dl.sort_box dd > ul > li").on("mousedown",function(event){
            ...
            filterValue[index] = $(this).find("button").attr('data-filter');
            filterValue.join(', ');
            filterAjaxChange(filterValue);
            event.preventDefault();
    });
