      ...
      <section id="marketArea">
         ...
         <div class="list">
             <ul>
               <li class="n1">
                 ...
                 <div class="spec">
                    <h3>회화</h3>
                    <a href="#categoriList" data-category="Conversation" class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n2">
                 ...
                 <div class="spec">
                    <h3>사진</h3>
                    <a href="#categoriList" data-category="Photo" class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n3">
                 ...
                 <div class="spec">
                    <h3>디자인</h3>
                    <a href="#categoriList" data-category="Design"  class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n4">
                 ...
                 <div class="spec">
                    <h3>판화</h3>
                    <a href="#categoriList" data-category="Print" class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n5">
                 ...
                 <div class="spec">
                    <h3>조각</h3>
                    <a href="#categoriList" data-category="Carving" class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n6">
                 ...
                 <div class="spec">
                    <h3>영상</h3>
                    <a href="#categoriList" data-category="Image" class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n7">
                 ...
                 <div class="spec">
                    <h3>설치</h3>
                    <a href="#categoriList" data-category="Installation" class="btn">View Detail &lt; </a>
                 </div>
               </li>
               <li class="n8">
                 ...
                 <div class="spec">
                    <h3>기타</h3>
                    <a href="#categoriList" data-category="Other" class="btn">View Detail &lt; </a>
                 </div>
               </li>
             </ul>
          </div><!--//list -->
       ...
       <div id="categoriList" class="tabBox">
          ...
          <ul style="display: block;">
                ...
                <li><a href="#categoriList" data-category=".<?php echo $val;?>" onclick="setCondition('medium', '<?php echo $i;?>');"><?php echo $aMedium[$i];?></a></li>
                <?php ++$i; endforeach; ?>
          </ul>
      </div>
      ...
      <div class="searchArea content-mediaBox margin1">
          <div class="inner">
                <ul class="sort_lst">
                    <li>
                        <dl class="sort_box">
                            <dt><button onmousedown="subject.value='';"><span>모든 테마</span></button></dt>
                            <dd>
                              <ul>

                                <li class="n0"><button onmousedown="setCondition('subject', '');">전체</button></li>
                                <?php $j = 0; $i = 1; foreach($aSubject as $val): ?>
                                <li class="n<?php echo $i;?>"><button onmousedown="setCondition('subject', '<?php echo ($j);?>');"><?php echo $val;?></button></li>
                                <?php ++$j; ++$i; endforeach; ?>
                              </ul>
                            </dd>
                        </dl>
                        ...
                        <dl class="sort_box">
                            ...
                            <dd>
                              <ul>
                                ...
                                <li class="n<?php echo $i;?>"><button onmousedown="setCondition('size', '<?php echo ($j);?>');"><?php echo $val;?></button></li>
                                <?php ++$j; ++$i; endforeach; ?>
                              </ul>
                            </dd>
                        </dl>
                    ...
                    <li>
                        <dl class="sort_box">
                            <dt><button onmousedown="color.value='';"><span>모든 컬러</span></button></dt>
                            <dd>
                              <ul>
                                <li class="n0"><button onmousedown="setCondition('color', '');">전체</button></li>
                                <?php $j = 0; $i = 1; foreach($aColor as $val): ?>
                                <li class="n<?php echo $i;?>"><button onmousedown="setCondition('color', '<?php echo ($j);?>');"><?php echo $val;?></button></li>
                                <?php ++$j; ++$i; endforeach; ?>
                              </ul>
                            </dd>
                        </dl>
                    ...
                    <li>
                        <dl class="sort_box">
                            <dt><button onmousedown="price.value='';"><span>모든 가격</span></button></dt>
                            <dd>
                              <ul>
                                <li class="n0"><button onmousedown="setCondition('price', '');">전체</button></li>
                                <?php $j = 0; $i = 1; foreach($aPrice as $val): ?>
                                <li class="n<?php echo $i;?>"><button onmousedown="setCondition('price', '<?php echo ($j);?>');"><?php echo $val;?></button></li>
                                <?php ++$j; ++$i; endforeach; ?>
                              </ul>
                            </dd>
                        </dl>
                ...
                <div class="search2">
                  <div class="lst_check type3">
                      <span>
                          ...
                          <input type="checkbox" name="rental" id="search2inp">
                      </span>
                      <span>
                          <label for="search3inp">판매중</label>
                          <input type="checkbox" name="sell" id="search3inp">
                      </span>
                     </div><!-- //lst_check -->
                     <div class="inpBox">
                          <input type="text" id="goods_name" name="goods_name" title="검색어 입력">
                          <button type="button" onclick="search();"><img src="/images/btn/btn_search.png" alt="검색하기"></button>
                     </div>
              </div>
           </div>
      </div><!-- //searchArea -->
...
<script>
// Search Function
var color = '', price = '', medium = '', subject = '', size = '', rental = '', sell = '', page = 1;

function search() {
	if ($("input:checkbox[name=rental]").is(":checked") === true) {
		rental = "Y";
	}
	else {
		rental = "";
	...
	if ($("input:checkbox[name=sell]").is(":checked") === true) {
		sell = "Y";
	}
	else {
		sell = "";
	 ...
	 $(".categori > .list > ul > li  a , #categoriList > ul > li > a").click(function(event){
      ...
      function ajaxData(num)
      {
           ...
           $.ajax({
               ...
               ansync : false,
               dataType:"html",
              data:{"price":price, "medium":medium, "subject":subject, "size":size, "color":color, "rental":rental, "sell":sell, "page":page, "goods_name":$("#goods_name").val()},
