              ...
              <!--
				...
				?>
                 ...
                 <ul>
                     <li class="on">
                       <div class="photo">
                            <a href="exhibitions.php?evt=22">
                                <img src="/images/tmp/img_july_newartist1.jpg?ver=1.1" alt="" class="pc" >
                                <img src="/images/tmp/img_july_newartist1_1.jpg?ver=1.1" alt="" class="mobile" >
                            </a>
                        </div>
                     </li>
                     <li>
                       <div class="photo">
                            <a href="exhibitions.php?evt=21">
                                <img src="/images/tmp/img_july_newartist2.jpg" alt="" class="pc" >
                                <img src="/images/tmp/img_july_newartist2_1.jpg" alt="" class="mobile" >
                            </a>
                        </div>
                     </li>
                     <li>
                       <div class="photo">
                            <a href="exhibitions.php?evt=20">
                                <img src="/images/tmp/img_july_collection.jpg" alt="" class="pc" >
                                <img src="/images/tmp/img_july_collection_1.jpg" alt="" class="mobile" >
                            </a>
                        </div>
                     </li>
                </ul>
