    ...
    <div class="container_inner">
      ...
      <input type="hidden" name="order_cnt" value="1">
		...
		<div class="marketArea content-mediaBox margin1">
			<div class="BigArea">
				<div class="img"><img src="<?php echo goodsMiddleImgUploadPath, $imgList[0]['goods_img'];?>" alt="" /></div>
				<div class="btn">
			...
			<div class="desArea">
				<p class="writer"><?php echo $Work->attr['artist_name'];?>&nbsp; <a href="artist.php?idx=<?php echo $Work->attr['artist_idx'];?>"><img src="/images/market/btn_more.jpg" alt="자세히 보기" /></a></p>
				<p class="tit"><?php echo $Work->attr['goods_name'];?></p>
				<p class="price">
						<span class="h">판매가</span> ￦ <?php echo number_format($Work->attr['goods_sell_price']);?>
						<?php if (!empty($Work->attr['goods_rental_price'])):?><span class="rantal"><span class="h">렌탈가</span> ￦ <?php echo $Work->attr['goods_rental_price'];?><span style="font-size:13px;display:inline-block; margin-top:-2px; margin-left:3px; vertical-align:1px "> / 월</span></span><?php endif;?>
						<span style="font-size:13px; line-height:12px; color: #8d8d8d; ">(렌탈 기간에 따라 요금이 상이합니다. <br>자세한 요율은 <a href="rental/index.php?goods=<?php echo $Work->attr['goods_idx']?>" style=" color: #333; border-bottom: 1px solid #333; padding-bottom: 3px; display: inline-block; *display: inline; *zoom: 1;">렌탈정책</a>을 참조해 주세요.)</span>
				</p>
				...
				<div class="btn">
					...
					<button class="btnPack2 normal min layerOpen request" onclick="location.href='/member/reservation.php?goods=<?php echo $Work->attr['goods_idx']?>&aj=1'"><span>REQUEST</span></button>
					...
					<a href="rental/index.php?goods=<?php echo $Work->attr['goods_idx']?>" class="btnPack2 normal min"><span>RENTAL</span></a>
					<?php endif; ?>
			...
			<div id="inforBox">
				...
				<div class="rgh_area">
					<div class="cont">
						...
						<p class="txt"><?php echo nl2br(strip_tags($Work->attr['goods_description']));?></p>
					</div>
				</div>
			</div>
