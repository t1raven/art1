			 ...
			 ?>
               <li class="n<?php echo $i; ?>">
                 ...
                 <div class="spec">
                    ...
                    <?php echo $aEngMedium_new[$z]; ?>|<?php echo $genre['goods_medium'];?><a href="#categoriList" onclick="medium=<?php echo $genre['goods_medium']; ?>;" data-filter=".<?php echo $aEngMedium_new[$z]; ?>" class="btn">View Detail &gt; </a>
                 </div>
               </li>
               <?php ++$i; ++$z; endforeach; ?>
              </ul>
   ...
   $.ajax({
          ...
          success : function(data) {
                  ...
                  $("<div id='tmpData'></div>").html(data).appendTo($container);
                    ...
                    $("#nextMore").css("display","none"); // 무조건 더보기 버튼을 초기화(hidden)
                    page ++;
